...
public class OrganisationList extends JFrame {
	...
	public OrganisationList() {
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblSortAll, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSort09, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSortA, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSortG, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSortK, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSortQ, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
							.addComponent(lblSortS, GroupLayout.PREFERRED_SIZE, 63, GroupLayout.PREFERRED_SIZE)
							.addGap(1)
		...
		JLabel lblMaxPage = new JLabel("of 2 |");
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGap(1)
					.addComponent(lblPre, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
					.addGap(1)
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(lblMaxPage, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
					.addGap(3)
					.addComponent(lblNext, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
					.addGap(1)
				...
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
							...
							.addGroup(gl_panel_2.createSequentialGroup()
								.addGap(3)
								.addComponent(txtPage, GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)))
